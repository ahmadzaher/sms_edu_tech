            ...
            <div class="tab-pane box active" id="sms">
                    ...
                    <div class="col-md-12 mb-sm">
                        <div class="form-group">
                            ...
                            <div class="checkbox-replace mt-sm pr-xs pull-right">
                                <label class="i-checks"><input type="checkbox" class="chk-sendsmsmail" name="chk_role"><i></i> <?=translate('select_all') ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row hidden-div" id="individual_div">
                    ...
                    <div class="col-md-12 mb-sm">
                        <div class="form-group">
                            ...
                            <div class="checkbox-replace mt-sm pr-xs pull-right">
                                <label class="i-checks"><input type="checkbox" class="chk-sendsmsmail" name="chk_recipients"><i></i> <?=translate('select_all') ?></label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-8 mb-sm">
                        <div class="form-group">
                            <label class="control-label"><?=translate('schedule_data') ?> <span class="required">*</span></label>
